...
public class ProfileFileLocationsTest {
    ...
    @Test
    public void homeDirectoryResolutionPriorityIsCorrect() throws Exception {
        ...
        assertThat(ProfileFileLocations.userHomeDirectory()).isNotEqualTo("home")
                                                            .isNotEqualTo("userprofile")
                                                            .isNotEqualTo("homedrivehomepath");
    }
}
