...
public class AwsErrorResponseHandler implements HttpResponseHandler<SdkException> {
    ...
    public SdkServiceException handle(HttpResponse response,
        ...
        final SdkServiceException exception = (SdkServiceException) handleAse(response, executionAttributes);
    ...
    private SdkException handleAse(HttpResponse response, ExecutionAttributes executionAttributes) throws Exception {
