...
public final class RetryUtils {
    ...
    public static boolean isRetryableServiceException(SdkException exception) {
        return isAse(exception) && RETRYABLE_STATUS_CODES.contains(toAse(exception).statusCode());
    }
    ...
    public static boolean isThrottlingException(SdkException exception) {
        return isAse(exception) && THROTTLING_ERROR_CODES.contains(toAse(exception).errorCode());
    }
    ...
    public static boolean isRequestEntityTooLargeException(SdkException exception) {
        return isAse(exception) && toAse(exception).statusCode() == HttpStatusCodes.REQUEST_TOO_LONG;
    }
    ...
    public static boolean isClockSkewError(SdkException exception) {
        return isAse(exception) && CLOCK_SKEW_ERROR_CODES.contains(toAse(exception).errorCode());
    }

    private static boolean isAse(SdkException e) {
        return e instanceof SdkServiceException;
    }

    private static SdkServiceException toAse(SdkException e) {
