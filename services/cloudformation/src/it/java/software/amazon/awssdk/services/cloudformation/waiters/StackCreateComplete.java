...
class StackCreateComplete {
    ...
    static class IsCREATE_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
        private static final JsonNode EXPECTED_RESULT;
    ...
    static class IsDELETE_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
        private static final JsonNode EXPECTED_RESULT;
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
        private static final JsonNode EXPECTED_RESULT;
    ...
    static class IsROLLBACK_FAILEDMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
        private static final JsonNode EXPECTED_RESULT;
    ...
    static class IsROLLBACK_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResponse, SdkServiceException> {
        private static final JsonNode EXPECTED_RESULT;
